import { Box, Button, Center, HStack, Image, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Text, useDisclosure } from '@chakra-ui/react'
    ...
    <Box fontFamily={'monospace'} h={800} bgGradient="linear(to-l, #7928CA, #FF0080)">
      ...
      <Modal closeOnOverlayClick={false} isOpen={isOpen} onClose={onClose}>
        ...
        {sellFlag && <>
                  ...
                  <Link to={'/home'}><Button onClick={sellItem}>SOLD</Button></Link>
                  </>
        }

        {addFlag && <> 
                  <Input type={'text'} onChange={(e)=>setAddQty(e.target.value)} placeholder={'enter add quantity'}  />
                  <Link to={'/home'}><Button onClick={addItem}>ADD</Button></Link>
                  </> 
        }
